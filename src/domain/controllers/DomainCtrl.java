...
public class DomainCtrl {
    ...
    public void generateKakuroFromParameters(String kakuroName, int rows, int columns, String difficulty, boolean forceUnique) {
    ...
    public void generateKakuroFromSeed(String kakuroName, String seed) {
