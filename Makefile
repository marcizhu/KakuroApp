...
app/SolverApp.class: app/SolverApp.java src/domain/controllers/Reader.java src/domain/controllers/Solver.java
	javac app/SolverApp.java

# Generator target
generator: app/GeneratorApp.class

app/GeneratorApp.class: app/GeneratorApp.java src/domain/controllers/Generator.java src/domain/entities/Board.java src/domain/entities/Difficulty.java
	javac app/GeneratorApp.java

# Unit tests
tests: test/SolverTest.class test/SwappingCellQueueTest.class test/GeneratorTest.class

test/SolverTest.class: test/SolverTest.java src/domain/controllers/Reader.java src/domain/controllers/Solver.java src/domain/entities/Board.java
...
test/GeneratorTest.class: test/GeneratorTest.java src/domain/controllers/Generator.java src/domain/entities/Board.java
